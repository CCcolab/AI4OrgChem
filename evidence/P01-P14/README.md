...
| P12 | Large annulenes approach polyene-like energetic behavior, but the exact size boundary is estimator-dependent. | **Partially consistent** | This is a **six-point mixed-provenance pilot**. The qualitative large-ring trend agrees, but N=10 is boundary-sensitive; the monograph CESE onset at **N=16/18** and independent ASE onset at **N>30** belong to different estimands and are not directly comparable. | [card](P12/data-card.md) · [protocol](P12/protocol.md) · [result](P12/result.json) · [report](P12/report.md) |
