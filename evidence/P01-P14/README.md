...
| P07 | A two-term “conjugative stabilization versus steric destabilization” account is insufficient for the tested mechanism. | **Scope-consistent** | This is a proposition-level integration of P04-P06, not a new QM calculation; energies from different state contracts are not summed. | [card](P07/data-card.md) · [protocol](P07/protocol.md) · [result](P07/result.json) · [report](P07/report.md) |
...
| P14 | Pi interaction can contribute to distortion in a strained aromatic system. | **Consistent** | The single-system C12H6 source-proxy endpoint is **+67.086899 kcal/mol**; this is not a reproduction of the complete 19-molecule strained-aromatic panel. | [card](P14/data-card.md) · [protocol](P14/protocol.md) · [result](P14/result.json) · [report](P14/report.md) |
