...
- 2025年独立ASE研究同样发现芳香/反芳香能量差随N增大而消失，但对中性体系给出的能量非芳香边界是N>30，而不是原著的N=16/18。两个估计量不同，不能把阈值视为同一结果。

最终判定：`P12_PARTIALLY_CONSISTENT_QUALITATIVE_BOUNDARY_CONSISTENT_EXACT_ONSET_CROSS_ESTIMATOR_INCONSISTENT`。

最准确表述是：**P12与原著部分一致：大环最终趋向能量非芳香/多烯行为的定性命题一致；精确起点在原著CESE的N=16/18与独立ASE的N>30之间不一致。两者估计量不同，故不作同估计量直接反证。**
