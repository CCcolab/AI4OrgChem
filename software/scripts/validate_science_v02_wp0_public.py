...
def main() -> int:
    ...
    if not failures:
        ...
        if gate.get("status") != "IN_PROGRESS_NOT_PASSED":
            failures.append("Gate V2-0 status is overstated")
        ...
        if smoke.get("authorization", {}).get("wp1_scientific_calculation") != "NOT_AUTHORIZED":
            failures.append("public WP0 record overstates WP1 authorization")
