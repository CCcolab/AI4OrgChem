...
> **Current published release:** [`v0.3.2`](https://github.com/CCcolab/AI4OrgChem/releases/tag/v0.3.2) — an evidence-interpretation maintenance release. Its machine-readable **13 consistent and 1 partially consistent (P12)** count is retained as the historical `v0.3.1` classification, not a newly justified P12 verdict. The [P12 corrigendum](P12_CORRIGENDUM.md) explains why the old cross-estimand rationale is invalid and why the precise CESE onset remains independently unconfirmed. No new QM result or P12 reclassification is introduced. Evidence identity, tested scope, and independence remain separate from the verdict label. The associated manuscript has not yet undergone peer review.
