...
> **当前已发布正式版：** [`v0.3.1`](https://github.com/CCcolab/AI4OrgChem/releases/tag/v0.3.1)——其**历史分类**为13项一致、1项部分一致（P12）。P12的理由见[发布后证据勘误](P12_CORRIGENDUM.md)；此次`main`更新不表示已经发布v0.3.2或重新判定P12。证据身份、受测范围和独立性与判定标签分列；相关论文稿尚未经过同行评审。
